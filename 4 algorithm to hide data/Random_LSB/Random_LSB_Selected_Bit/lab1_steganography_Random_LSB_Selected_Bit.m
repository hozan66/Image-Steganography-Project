...
mytext=required_text_for_each_image_using_Random_LSB_Selected_Bit(text, origin_image);

% stego_key is seed value
stego_key=1999;
for bit=1:8
    % Hide info
    stego_image=hide_info_using_Random_LSB_Selected_Bit(mytext, origin_image, bit, stego_key);
    ...
    % Extract info
    info=extract_info_using_Random_LSB_Selected_Bit(stego_image, bit, stego_key);
    disp(info);
    disp('=====================================================');
end

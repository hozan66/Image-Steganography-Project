...
for bit=1:8
    ...
    mytext=required_text_for_each_image_using_Random_LSB_Several_Bits(text, origin_image, bit);
    
    % Hide info
    stego_image=hide_info_using_Random_LSB_Several_Bits(mytext, origin_image, bit, stego_key);
    ...
    % Extract info
    info=extract_info_using_Random_LSB_Several_Bits(stego_image, bit, stego_key);
    disp('=====================================================');
    disp(info);
end
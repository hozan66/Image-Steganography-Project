...
for i=1:length(photo) 
    figure,
     for bit=1:8
         ...
         mytext=required_text_for_each_image_using_Sequential_LSB_Several_Bits(text, photo{i}, bit);
         
        % Hide info
        stego_image=hide_info_using_Sequential_LSB_Several_Bits(mytext, photo{i}, bit);
        stego_image=uint8(stego_image);
        
        % Saving stego_image
        saving_path='C:\Users\Lenovo\Documents\MATLAB\Steganography\Sequential_LSB\Sequential_LSB_Several_Bits\Sequential_LSB_Several_Bits_Images\';
...
mytable=table(SLSB1',SLSB2',SLSB3',SLSB4',SLSB5',SLSB6',SLSB7',SLSB8','VariableNames',{'Sequential_LSB_Several_1Bits','Sequential_LSB_Several_2Bits','Sequential_LSB_Several_3Bits','Sequential_LSB_Several_4Bits','Sequential_LSB_Several_5Bits','Sequential_LSB_Several_6Bits','Sequential_LSB_Several_7Bits','Sequential_LSB_Several_8Bits'});
writetable(mytable,file_name,'Sheet','Sequential_LSB_Several_Bits','Range','H1');
